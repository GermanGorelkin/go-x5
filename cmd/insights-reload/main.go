...
func main() {
	...
	// 20230101-20230531
	beginDate, _ := time.Parse("2006-01-02", "2023-01-01")
	endDate, _ := time.Parse("2006-01-02", "2023-05-31")
...
func getPeriod() (begin, end time.Time) {
	begin, _ = time.Parse("2006-01-02", "2021-01-04")
	end, _ = time.Parse("2006-01-02", "2021-06-27")
	return
}
